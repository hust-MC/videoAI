...
public class TensorFlowObjectDetectionAPIModel implements Classifier {
    ...
    public static String MODEL_FILE = "file:///android_asset/ssd_mobilenet_v1_android_export.pb";
    public static String LABEL_FILE = "file:///android_asset/coco_labels_list.txt";
